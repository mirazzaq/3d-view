...
export default function Home() {
  return (
    <div className="flex w-full h-screen bg-slate-900">
      {/* Left Sidebar */}
      <div className="w-96 bg-slate-900 border-r border-slate-700 p-6 flex flex-col overflow-y-auto z-10">
        <h1 className="text-4xl font-bold text-white mb-2">3D Frame Viewer</h1>
